...
class RaftNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteOperation = channel.unary_unary(
                '/RaftNode/ExecuteOperation',
                request_serializer=raft__pb2.ExecuteOperationRequest.SerializeToString,
                response_deserializer=raft__pb2.ExecuteOperationResponse.FromString,
                _registered_method=True)
...
def add_RaftNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ExecuteOperation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__pb2.ExecuteOperationRequest.FromString,
                    response_serializer=raft__pb2.ExecuteOperationResponse.SerializeToString,
            ),
    }
...
class RaftNode(object):
    ...
    def ExecuteOperation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/RaftNode/ExecuteOperation',
            raft__pb2.ExecuteOperationRequest.SerializeToString,
            raft__pb2.ExecuteOperationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
